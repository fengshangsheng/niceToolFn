...
const TipBox = (props: any) => {
  return <div datatype={'1111111111111'}>
    <p>~~~~{props.count}~~~</p>
    <p>{props.count % 2 ? '1111111111111' : '222222222222222'}</p>
  </div>
}
...
const App = () => {
  ...
  return <div>
    ...
    >
      <button
        style={({ background: 'red', position: 'absolute', left: '100px', top: '100px' })}
        onClick={() => handleEv()}
      >component</button>
    </Tooltip>
    <div></div>
    ...
    >
      <button
        style={({ background: 'red', position: 'absolute', left: '200px', top: '200px' })}
        onClick={() => handleEv()}
      >component</button>
    </Tooltip>
    <div>fengfeng123</div>
